...
byf_clickError() {
	...
	ImageSearch, errorokX, errorokY, 0, 0, A_ScreenWidth, A_ScreenHeight, *78 settings\images\errorok.png
	If (ErrorLevel == 0) {
...
Help:
Run, % "explorer.exe /e`, /n`, /select` /open` ," A_ScriptDir "\Byfron_Setup.pdf"
Return
